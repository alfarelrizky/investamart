...
@section('style_custom')
    <link rel="stylesheet" href="{{asset('css/custom/style3.css')}}">
@endsection

@section('content')
    {{-- jumbotron --}}
        <img class='bg-jumbotron' src="{{asset('img/jumbotron-red.png')}}" alt="">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <img class='icon-jumbotron' src="{{asset('img/human3.png')}}" alt="">
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="text-center text-light">
                        <div>
                            ...
                            <span class='title' style='font-size:6.8vw;'><strong>THE YOLO</strong></span><br>
                            <span style='font-size:3vw;'>A.K.A AGRESIf</span><br>                        
                            <div class="p-4 text">
