    ...
    {{-- jumbotron --}}
        ...
        <div class="container">
            ...
            <div class="py-4">
                <div class="row" style>
                    <div class="col-lg-12">
                        <p class='text-white pengantar' style='font-size:2vw;line-height:1.2;text-align:justify'>
                        ...
                        <div class="d-flex justify-content-center mt-4">
                            <a href='{{route('investamart.quizm',$id)}}' class="btn tombol text-white" style='background-color:black;;font-size:2vw;'>MULAI SEKARANG &nbsp;<i class='fas fa-arrow-right'></i></a>
                        </div>
                    </div>
                </div>
            </div>  
