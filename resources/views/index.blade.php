                ...
                <div class="col-md-12">
                    <div class="text-center text-light">
                        <div>
                            ...
                            <span style='font-size:6.8vw;'><strong>THE OPPORTUNIST</strong></span><br>
            ...
            <div class="row mt-4" style>
                <div class="col-lg-12 mt-4 mb-4">
                    <div class="text-center" style='color:yellow;'>
                        <div style='font-size:3vw;'>AYO MULAI BERINVESTASI DARI SEKARANG <br>DAN DAPATKAN BONUS  DIAWAL SEBESAR <br> <strong>IDR 1,000,000</strong> REKSADANA TUNAI</div>
                    </div>
                </div>
                 <div class="col-lg-12 mt-4 mb-4 p-5">
                    <div class="text-center text-light">
